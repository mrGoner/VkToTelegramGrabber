...
internal static class RequestBuilder
{
        ...
        string _sourceIds, int _count = 50, string _nextToken = null)
    {
        ...
        var newsfeedRequest =
            $"newsfeed.get?filters=post&access_token={_token}&v={_apiVersion}&start_time={epochStartTime}&end_time={epochEndTime}&source_ids={_sourceIds}&count={_count}";
    ...
    public static string BuildLikeRequest(LikeType _type, int _ownerId, uint _itemId, string _token, string _apiVersion)
    {
        ...
        var url =
            $"likes.add?type={_type.ConvertToSnakeCase()}&owner_id={_ownerId}&item_id={_itemId}&access_token={_token}&v={_apiVersion}";
